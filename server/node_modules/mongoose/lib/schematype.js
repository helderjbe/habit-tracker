...
SchemaType.prototype.getDefault = function(scope, init) {
  let ret =
    typeof this.defaultValue === 'function' ? this.defaultValue.call(scope) : this.defaultValue;
...
SchemaType._isRef = function(self, value, doc, init) {
  ...
  if (ref) {
    ...
    if (
      !Buffer.isBuffer(value) && // buffers are objects too
