      ...
      if (!schematype) {
        ...
        if (schematype) {
          ...
          if (schematype.caster && schematype.caster.schema) {
            ...
            obj[path] = cast(schematype.caster.schema, remainingConds, options, context)[
              pathLastHalf
            ];
          } else {
            obj[path] = val;
        ...
        if (utils.isObject(val)) {
          ...
          if (geo) {
            ...
            if (geo === '$within') {
              const withinType =
                value.$center || value.$centerSphere || value.$box || value.$polygon;
              ...
              if (value.$geometry) {
                ...
                if (ALLOWED_GEOWITHIN_GEOJSON_TYPES.indexOf(geoWithinType) === -1) {
                  throw new Error(
                    'Invalid geoJSON type for $geoWithin "' +
                      geoWithinType +
