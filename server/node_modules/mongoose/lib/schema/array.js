...
SchemaArray.prototype.checkRequired = function checkRequired(value, doc) {
  ...
  const _checkRequired =
    typeof this.constructor.checkRequired == 'function'
  ...
  while (arr.$isMongooseArray && !arr.$isMongooseDocumentArray) {
    ...
    if (arr == null || typeof arr === 'function') {
      throw new MongooseError(
        'You can only add an embedded discriminator on ' +
          'a document array, ' +
          this.path +
          ' is a plain array'
      );
    ...
    if (
      ...
      if (
        ...
        const constructorByValue = getDiscriminatorByValue(
          Constructor,
          val[Constructor.schema.options.discriminatorKey]
        );
...
handle.$eq = handle.$gt = handle.$gte = handle.$lt = handle.$lte = handle.$ne = handle.$regex =
