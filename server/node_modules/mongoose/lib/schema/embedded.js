...
Embedded.prototype.$conditionalHandlers.$near = Embedded.prototype.$conditionalHandlers.$nearSphere =
  geospatial.cast$near;

Embedded.prototype.$conditionalHandlers.$within = Embedded.prototype.$conditionalHandlers.$geoWithin =
  geospatial.cast$within;
...
Embedded.prototype.doValidate = function(value, fn, scope, options) {
  ...
  SchemaType.prototype.doValidate.call(
    this,
    value,
    function(error) {
      if (error) {
