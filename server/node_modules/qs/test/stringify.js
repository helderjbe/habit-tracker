...
test('stringify()', function(t) {
    ...
    t.test('stringifies a nested array value with dots notation', function(st) {
        ...
        st.equal(
            qs.stringify({ a: { b: ['c', 'd'] } }, { allowDots: true, encode: false }),
            'a.b[0]=c&a.b[1]=d',
    ...
    t.test('stringifies an object inside an array with dots notation', function(st) {
        ...
        st.equal(
            qs.stringify({ a: [{ b: { c: [1] } }] }, { allowDots: true, encode: false }),
            'a[0].b.c[0]=1',
            'default => indices'
        );
    ...
    t.test('drops keys with a value of undefined', function(st) {
        ...
        st.equal(
            qs.stringify({ a: { b: undefined, c: null } }, { strictNullHandling: true }),
            'a%5Bc%5D'
        );
        st.equal(
            qs.stringify({ a: { b: undefined, c: null } }, { strictNullHandling: false }),
            'a%5Bc%5D='
        );
    ...
    t.test('selects properties when filter=array', function(st) {
        ...
        st.equal(
            qs.stringify({ a: { b: [1, 2, 3, 4], c: 'd' }, c: 'f' }, { filter: ['a', 'b', 0, 2] }),
            'a%5Bb%5D%5B0%5D=1&a%5Bb%5D%5B2%5D=3',
            'default => indices'
        );
    ...
    t.test('can disable uri encoding', function(st) {
        ...
        st.equal(
            qs.stringify({ a: 'b', c: null }, { strictNullHandling: true, encode: false }),
            'a=b&c'
        );
        st.end();
    });
    ...
    t.test('encodeValuesOnly - strictNullHandling', function(st) {
        st.equal(
            qs.stringify({ a: { b: null } }, { encodeValuesOnly: true, strictNullHandling: true }),
            'a[b]'
        );
        st.end();
    });
    ...
    t.test('adds the right sentinel when instructed to and the charset is iso-8859-1', function(
        st
    ) {
        st.equal(
