...
test('parse()', function(t) {
    ...
    t.test('transforms arrays to objects (dot notation)', function(st) {
        ...
        st.deepEqual(
            qs.parse('foo[0].baz[0]=15&foo[0].baz[1]=16&foo[0].bar=2', { allowDots: true }),
            { foo: [{ baz: ['15', '16'], bar: '2' }] }
        );
        ...
        st.deepEqual(
            qs.parse('foo[0].a=a&foo[0].b=b&foo[1].a=aa&foo[1].b=bb', { allowDots: true }),
            { foo: [{ a: 'a', b: 'b' }, { a: 'aa', b: 'bb' }] }
        );
        st.end();
    });
    ...
    t.test('uses the utf8 sentinel to switch to utf-8 when no default charset is given', function(
        st
    ) {
        st.deepEqual(
            qs.parse(
    ...
    t.test('interprets numeric entities in iso-8859-1 when `interpretNumericEntities`', function(
        st
    ) {
        st.deepEqual(
